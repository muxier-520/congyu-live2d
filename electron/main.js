...
body{background:transparent;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;font-family:"Microsoft YaHei",sans-serif;color:#fff;overflow:hidden}
...
function createTray() {
  ...
  const contextMenu = Menu.buildFromTemplate([
    ...
    { label: '用浏览器打开', click: () => { shell.openExternal(`http://localhost:${CONFIG.port}/`); } },
