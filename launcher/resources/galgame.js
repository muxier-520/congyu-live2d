...
class VNBridge {
  ...
  handleButtonClick(id) {
    ...
    switch (id) {
      ...
      case 'vn-btn-mic':
        this.toggleModal('recorder-modal');
        break;
      case 'vn-btn-model':
        this.toggleModal('model-modal');
        break;
      case 'vn-btn-skills':
        this.toggleModal('skills-modal');
        break;
      case 'vn-btn-menu':
  ...
  toggleModal(id) {
    ...
    if (!el) return console.error('[VNBridge] modal not found:', id);
